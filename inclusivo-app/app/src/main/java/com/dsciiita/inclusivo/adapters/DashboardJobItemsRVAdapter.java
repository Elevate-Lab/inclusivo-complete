...
public class DashboardJobItemsRVAdapter extends RecyclerView.Adapter<DashboardJobItemsRVAdapter.ViewHolder>{
    ...
    public DashboardJobItemsRVAdapter(@NonNull Context context, int res, List<TitleLinkObject> companyList, onCompanyListener mOnNoteListener) {
