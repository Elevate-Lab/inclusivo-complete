...
public class CompanyStoryResponse implements Serializable
{
     ...
     * @param status
     */
    public CompanyStoryResponse(String status, String message, List<Story> data) {
        super();
        this.status = status;
